    ...
    <div>
      ...
      <main className='max-w-7xl mx-auto px-8 sm:px-16'>
        <section className='pt-16'>
          <div className='w-12 border-b-4 border-blue-900'>&nbsp;</div>
          <h2 className='text-2xl md:text-4xl font-semibold pb-2'>Services Offered</h2>
          <p className='text-gray-400 text-lg'>We are committed to providing the best security services</p>
            ...
            <div className='flex flex-col mt-5'>
              <div className='mb-8'>
                  <div className='flex items-center space-x-1'>
                    <ShieldCheckIcon className='h-8 text-blue-900' />
                    <h1 className='text-blue-900 font-semibold text-lg mb-2'>
                        Security Guards
                    </h1>
                  </div>
              ...
              <div className='mb-8'>
                  <div className='flex items-center space-x-1'>
                    <TruckIcon className='h-8 text-blue-900' />
              ...
              <div className='mb-8'>
                  <div className='flex items-center space-x-1'>
                    <UserGroupIcon className='h-8 text-blue-900' />
                    <h1 className='text-blue-900 font-semibold text-lg'>
                        Body Guards
                    </h1>
                  </div>
              ...
              <div className='w-12 border-b-4 border-blue-900'>&nbsp;</div>
              <h2 className='text-2xl md:text-4xl font-semibold pb-2 mb-2'>Why Choose Us</h2>
